...
public class Bat extends Enemies {
    ...
    void loadAbilities() throws IOException {
        ...
        abilities[1] = new Ability(60, 40, false, false, new Projectile[]{new Projectile_Static("Bite", 156, 156, 30, 30, new Ellipse2D.Double(0, 0, 156, 156), 30, 2, new int[] {10, 30})});
        ...
        abilities[3] = new Ability(150, 300, true, true, new Projectile[]{new Projectile_Moving("Bat_Ball", 96, 96, 0, -50, gs.player.worldX, gs.player.worldY, 3, false, new Ellipse2D.Double(0, 0, 96, 96), 5, 10,11, new int[] {2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2})});
    }
